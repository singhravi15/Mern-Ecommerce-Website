...
const ProductItem = () => {
  return (
    <div className="productItem rounded-md overflow-hidden border-2 border-[rgba(0,0,0,0.1)] !mt-8 padding-[15px] shadow-lg">
      ...
      <div className="info !p-3">
        ...
        <h3 className="text-[13px] font-[500] title !mt-1 text-[rgba(0,0,0,0.9)]">
          <Link to="/" className="link">
